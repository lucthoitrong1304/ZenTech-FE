...
import { ManagementChatWorkspace } from '../models/management-chat.models';
...
const MOCK_WORKSPACE: ManagementChatWorkspace = {
  conversations: [
    {
...
export class ManagementChatService {
  getWorkspace(): Observable<ManagementChatWorkspace> {
    return of({
