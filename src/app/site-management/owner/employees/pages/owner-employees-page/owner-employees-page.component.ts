...
import {
  ...
  OwnerEmployeeRole,
  OwnerEmployeeSort,
} from '../../data-access/models/owner-employee.models';
import { OwnerEmployeesStore } from '../../data-access/store/owner-employees.store';

type ActiveFilterValue = 'all' | 'active' | 'inactive';
type RoleFilterValue = 'all' | OwnerEmployeeRole;
...
@Component({
  ...
  styleUrl: './owner-employees-page.component.css',
  providers: [OwnerEmployeesStore],
})
export class OwnerEmployeesPageComponent {
  protected readonly store = inject(OwnerEmployeesStore);
  private readonly toastService = inject(ToastService);
  protected readonly employeeRoles: OwnerEmployeeRole[] = ['MANAGER', 'EMPLOYEE'];
  ...
  protected onSortChange(event: Event): void {
    this.store.setSort(readSelectValue(event) as OwnerEmployeeSort);
  }
  ...
  protected getRoleLabel(role: OwnerEmployeeRole): string {
  ...
  protected getEmployeeInitials(employee: OwnerEmployee): string {
