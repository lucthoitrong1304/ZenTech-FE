...
import { ProductReviewDraft } from '@/site-management/customer/catalog/detail/data-access/models/product-detail-view.model';
import { AddReviewModalComponent } from '@/site-management/customer/catalog/detail/components/add-review-modal/add-review-modal.component';
import { ProductDetailGalleryComponent } from '@/site-management/customer/catalog/detail/components/product-detail-gallery/product-detail-gallery.component';
import { ProductReviewListComponent } from '@/site-management/customer/catalog/detail/components/product-review-list/product-review-list.component';
